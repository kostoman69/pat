// Οι παρακάτω κλάσεις έχουν παραχθεί από
// https://javiercbk.github.io/json_to_dart/
// και αφού πρώτα "επαύξησα" το JSON που επιστρέφει η api/RangeParamValues/{id} σε:
//  { "RangeValue": + JSON +  }
// και μετονόμασα την κλάση Autogenerated σε RangeValueList
// Στη συνέχεια, έκανα μία τροποποίηση στον named constructor RangeValueList.fromJson
// Δημιουργώ ένα map Map<String, RangeParams> _rangeTypes (private variable) που περιέχει τους τύπους των Range values
// με τις περαμέτρους τους (π.χ. "Pain" -> {id:1, name:'Pain', valueFrom:0.0, valueUntil:100.0, step:1.0})
// και το μετατρέπω σε λίστα, την List<RangeParams> rangeTypes που είναι public variable.
class RangeValueList {
  List<RangeValue> rangeValue;
  Map<String, RangeParams> _rangeTypes;
  List<RangeParams> rangeTypes;
  ...
  RangeValueList.fromJson(Map<String, dynamic> json) {
    ...
    if (json['RangeValue'] != null) {
      ...
      json['RangeValue'].forEach((v) {
        ...
        rangeValue.add(rv);
        _rangeTypes.putIfAbsent(rv.rangeParams.name, () => rv.rangeParams);
      });

      _rangeTypes.forEach((k, v) => rangeTypes.add(RangeParams(
            id: v.id,
            name: k,
            valueFrom: v.valueFrom,
            valueUntil: v.valueUntil,
            step: v.step,
          )));
    }
  }
