...
class InitialHintAnimation2 extends StatelessWidget {
  final List<charts.Series> seriesList;
  final bool animate;

  InitialHintAnimation2(this.seriesList, {this.animate});

  factory InitialHintAnimation2.withSampleData({animate}) {
    return new InitialHintAnimation2(
      _createSampleData(),
      animate: animate,
    );
  }

  factory InitialHintAnimation2.withRealData(
      {@required List<BarChartData> data, animate}) {
    return new InitialHintAnimation2(
      _createRealData(data),
      animate: animate,
    );
  }
  ...
  // Create one series with sample hard coded data.
  static List<charts.Series<BarChartData, String>> _createRealData(
  ...
  static List<charts.Series<BarChartData, String>> _createSampleData() {
    final data = [
      new BarChartData('2014 10:30', 5),
      new BarChartData('2015 11:40', 25),
      new BarChartData('2016 23:00', 100),
      new BarChartData('2017 13:00', 75),
    ];
